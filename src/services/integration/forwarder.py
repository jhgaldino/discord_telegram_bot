...
class MessageForwarder:
    ...
    def _load_discord_channels(self) -> None:
        ...
        for channel in channels:
            channel = bot.get_partial_messageable(channel.channel_id)
            if channel:
    ...
    def _register_handlers(self) -> None:
        ...
        telegram_client.client.add_event_handler(
            self._forward_message_handler, event_builder
        )
    ...
    def _unregister_handlers(self) -> None:
        ...
        registered_handlers = telegram_client.client.list_event_handlers()
        ...
        for callback, event_builder in registered_handlers:
            if callback == self._forward_message_handler:
                telegram_client.client.remove_event_handler(callback, event_builder)
    ...
    async def on_bot_ready(self) -> None:
        ...
        for channel in self._discord_channels:
            try:
                ...
                logger.error(f"Failed to send ready message to '{channel.id}': {e}")
